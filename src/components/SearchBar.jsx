            ...
            <Grid item xs={12} md={3}>
              <FormControl fullWidth size='small'>
                ...
                >
                  ...
                  <MenuItem key='1000' value='2000'>
                    1500-2000
                  </MenuItem>
                  <MenuItem key='2500' value='2500'>
                    2000-2500
                  </MenuItem>
                  <MenuItem key='3000' value='3000'>
                    2500-3000
                  </MenuItem>
                </Select>
              </FormControl>
      ...
      <Container maxWidth='lg'>
        ...
        <Grid container spacing={1}>
          {" "}
          {
            ...
            hotelList.map((holiday, index) => {
              return (
                <Grid item xs='auto'>
                  <div data-testid={`holiday-item-${index}`}></div>
